...
[
	...
	".glyphicons.btn-action.btn-primary, .glyphicons.btn-action.btn-primary:hover",
	".progress.progress-primary .bar",
	".nav-tabs > li > a:hover, .nav-pills > li > a, .nav-pills > li > a:hover",
	".gallery ul li .thumb .hover",
	".blog ul li .item .hover",
	".alert.alert-primary"
];
...
[
	...
	"ul.history li h4",
	".color-primary, .color-primary.glyphicons i:before",
	"blockquote small"
];
